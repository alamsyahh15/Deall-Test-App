...
//
//     final repositoriesResponse = repositoriesResponseFromJson(jsonString);

import 'dart:convert';

RepositoriesResponse repositoriesResponseFromJson(String str) =>
    RepositoriesResponse.fromJson(json.decode(str));

String repositoriesResponseToJson(RepositoriesResponse data) =>
...
enum KeyRepository { GPL_30, MIT, APACHE_20 }

final keyValues = EnumValues({
  "apache-2.0": KeyRepository.APACHE_20,
  "gpl-3.0": KeyRepository.GPL_30,
  "mit": KeyRepository.MIT
});

enum Name { GNU_GENERAL_PUBLIC_LICENSE_V3_0, MIT_LICENSE, APACHE_LICENSE_20 }
...
enum SpdxId { GPL_30, MIT, APACHE_20 }
...
enum TypeRepository { ORGANIZATION, USER }

final typeValues = EnumValues(
    {"Organization": TypeRepository.ORGANIZATION, "User": TypeRepository.USER});
